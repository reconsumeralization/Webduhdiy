...
const Button = react_1.default.forwardRef(
  (
    {
      className,
      variant,
    ...
    const buttonContent = (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
      children: [
        loading &&
        ...
        !loading &&
          icon &&
          iconPosition === 'right' &&
          (0, jsx_runtime_1.jsx)('span', { className: 'ml-2', children: icon }),
      ],
    });
    return (0, jsx_runtime_1.jsx)('button', {
      className: (0, clsx_1.clsx)(buttonVariants({ variant, size, className })),
      ref: ref,
      disabled: isDisabled,
      ...props,
