    ...
    const baseChat = (
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row overflow-y-auto w-full h-full">
            ...
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                ...
                <p className="text-md lg:text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                  The Ultimate v0.dev Competitor - Build amazing projects with multi-LLM AI assistance
                </p>
                <div className="flex flex-wrap justify-center gap-2 mb-8 animate-fade-in animation-delay-400">
                ...
                >
                  ...
                  >
                    <textarea
                      ...
                      placeholder="How can Webduh AI Builder help you today?"
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
          ...
          <ClientOnly>
            {() => (
              <Workbench actionRunner={actionRunner ?? ({} as ActionRunner)} />
            )}
          </ClientOnly>
        </div>
      </div>
