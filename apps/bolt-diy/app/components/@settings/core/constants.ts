...
export const TAB_ICONS: Record<TabType, string> = {
  ...
  debug: 'i-ph:bug-fill',
  'event-logs': 'i-ph-scroll-duotone',
  update: 'i-ph-sparkle-duotone',
  'task-manager': 'i-ph-chart-line-up-duotone',
  'tab-management': 'i-ph-tabs-duotone',
  editor: 'i-ph-code-duotone',
};
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  editor: 'Edit code and files in the built-in editor',
};
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'editor', visible: true, window: 'user' as const, order: 13 },
  ...
  { id: 'editor', visible: true, window: 'developer' as const, order: 13 },
];
