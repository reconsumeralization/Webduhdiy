...
import EditorTab from '~/components/@settings/tabs/editor/EditorTab';
...
const BETA_TABS = new Set<TabType>(['task-manager', 'service-status', 'update', 'local-providers', 'editor']);
...
const AnimatedSwitch: React.FC<AnimatedSwitchProps> = ({ checked, onCheckedChange, id, label }) => (
